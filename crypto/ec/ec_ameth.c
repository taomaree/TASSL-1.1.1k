...
static int eckey_pub_decode(EVP_PKEY *pkey, X509_PUBKEY *pubkey)
{
    ...
    /* we use SM2 pkey method for SM2 algorithm rather than
     * EC pkey method, so set alias type */
    if (NID_sm2 == EC_GROUP_get_curve_name(EC_KEY_get0_group(EVP_PKEY_get0_EC_KEY(pkey))))
